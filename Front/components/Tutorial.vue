  ...
  <div class="relative flex items-top justify-center min-h-screen bg-gray-100 sm:items-center sm:pt-0">
    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      ...
      <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
        <h2 class="text-2xl leading-7 font-semibold">Welcome to the Chat project of our group !</h2>
        ...
        <br />
        <p>This project was been created by :</p>
        <ul>
          <li>- El Guendouz Ayoub</li>
          <li>- Le Bras Sacha</li>
          <li>- Ait Ouaret Ahmed-Jibril</li>
          <li>- Galeuzzi Sacha</li>
          <li>- Kevin Ho</li>
          <li>- Yann Decelle</li>
        </ul>
        <br />
        <nuxt-link to="message" class="text-green-500 hover:underline">Click here to see the general chat</nuxt-link>
      </div>
